...
import me.colormaestro.taskmanager.listeners.PlayerTasksViewListener;
...
public final class TaskManager extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new PlayerTasksViewListener(this, taskDAO), this);
