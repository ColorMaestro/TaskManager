...
public class IdleTaskViewListener extends InventoryListener {
    ...
    public IdleTaskViewListener(Scheduler scheduler, RunnablesCreator creator) {
        super(scheduler, creator, Directives.IDLE_TASKS);
    }
    ...
    private void handleArrowClick(HumanEntity player, PersistentDataHolder holder) {
        scheduler.runTaskAsynchronously(creator.showIdleTasksView(player, determineNextPage(holder)));
    }
}
